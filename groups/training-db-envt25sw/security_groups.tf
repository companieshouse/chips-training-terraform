resource "aws_security_group" "training_db_envt25sw" {
...
resource "aws_vpc_security_group_ingress_rule" "training_db_envt25sw_ssh" {
  description       = "Allow SSH connectivity for application deployments"
  security_group_id = aws_security_group.training_db_envt25sw.id
...
resource "aws_vpc_security_group_ingress_rule" "training_db_envt25sw_admin_ssh" {
...
resource "aws_vpc_security_group_egress_rule" "training_db_envt25sw_all_out" {
