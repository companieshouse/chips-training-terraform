resource "aws_security_group" "chips_training_01" {
...
resource "aws_vpc_security_group_ingress_rule" "chips_training_01_ssh" {
...
resource "aws_vpc_security_group_egress_rule" "chips_training_01_all_out" {
