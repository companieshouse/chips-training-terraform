...
public_key = jsondecode(nonsensitive(data.vault_generic_secret.public_key.data["training-db-fes25"]))
  training_db_fes25_public_key = base64decode(local.public_key["public_key"])
