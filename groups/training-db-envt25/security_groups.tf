resource "aws_security_group" "training_db_envt25" {
...
resource "aws_vpc_security_group_ingress_rule" "training_db_envt25_ssh" {
  description       = "Allow SSH connectivity for application deployments"
  security_group_id = aws_security_group.training_db_envt25.id
...
resource "aws_vpc_security_group_ingress_rule" "training_db_envt25_admin_ssh" {
...
resource "aws_vpc_security_group_egress_rule" "training_db_envt25_all_out" {
